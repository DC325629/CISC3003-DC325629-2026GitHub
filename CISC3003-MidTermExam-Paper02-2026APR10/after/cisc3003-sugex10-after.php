...
<head>
    <!-- 修改 title： -->
    <title>CISC3003 - DC325629 LAM KA WAI</title>
    <meta charset="utf-8">
...
<div class="mdl-cell mdl-cell--12-col card-lesson mdl-card  mdl-shadow--2dp">
    ...
    <!-- ==================== FOOTER  ==================== -->
    <footer style="text-align: center; padding: 20px; background-color: #eceff1; color: #333; font-size: 14px; border-top: 1px solid #ccc;">
        CISC3003 Web Programming: DC325629 LAM KA WAI 2026
    </footer>
    <!-- ======================================================== -->
